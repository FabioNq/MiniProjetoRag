...
model_infos = mlflow.search_registered_models(filter_string="name = 'rag3'")[0]
...
def predict():
    ...
    prompt = f"""
    Você é um assistente que ajuda a responder questões sobre tópico de Machine learning

    Responda a pergunta abaixo usando contexto com os documentos encontrados sobre Machine learning.
    ...
    Sumarize a resposta com o contexto e responda de forma clara, objetiva e descontraída com no máximo 300 caracteres. Lembre-se que são respostas objetivas e simples, tente encontrar a palavra do contexto independente se for maiuscula ou minuscula e com acentos.
