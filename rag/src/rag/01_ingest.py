...
def doc_to_vectordb(path):
    ...
    for c in chunks: 
        ...
        sparse_embedding = list(sparse_model.passage_embed(c.text))[0].as_object()
        colbert_embedding = list(colbert_model.passage_embed(c.text))[0].tolist()
